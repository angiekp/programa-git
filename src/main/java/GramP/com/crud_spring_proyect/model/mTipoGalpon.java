...
//Anotaciones
@Entity
@Table(name="mTipoGalpon")

public class mTipoGalpon {
    //Anotaciones
    @Id
    ...
    public mTipoGalpon(int id, String temperaturaG, String cantidadPollo, String aseo, String controlPlaga, String estado, String codMant) {
        this.id = id;
